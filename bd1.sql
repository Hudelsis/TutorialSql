...
------Problema 1 y 2 de Concepto 2 ------

------Problema 1 ------------

-----Eliminar Agenda si existe-----

if object_id('Agenda') is not null
  drop table Agenda;

-----Tabla Agenda me da erro por el / ----------
create table / Agenda
(Apellido varchar(30),
Nombre varchar(20),
...
----Visualisa las tablas existentes creada por el usuario--------
